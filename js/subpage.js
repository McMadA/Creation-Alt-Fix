document.addEventListener('DOMContentLoaded', async function() {
    ...
    const translations = {
        'nl': {
            ...
            "overMijMissieP2": "Ik benader IT-uitdagingen sterk analytisch. Ik doorzie complexe systemen snel en vertaal ze naar logische en uiterst effici\u00ebnte oplossingen voor jouw bedrijf.",
            "overMijMissieP3": "Mijn focus ligt uitsluitend op <strong>Software-Only Services</strong>. Denk hierbij aan software support, systeembeheer en slimmere werkprocessen. <span class=\"text-primary\">Let op: ik voer geen computer- of hardware reparaties meer uit.</span>",
        ...
        'en': {
            ...
            "overMijMissieP1": "Technology should work for you, not the other way around. With a personal approach and results-oriented solutions, I ensure digital challenges become clear and manageable.",
            "overMijMissieP2": "I approach IT challenges from a highly analytical perspective. I quickly understand complex systems and translate them into logical and highly efficient solutions for your business.",
            "overMijMissieP3": "My focus is strictly on <strong>Software-Only Services</strong>. This includes software support, system administration, and smarter workflows. <span class=\"text-primary\">Please note: I no longer perform computer or hardware repairs.</span>",
            ...
            "overMijTechP": "I combine years of IT experience with the latest AI developments to build innovative and robust solutions. I prefer working with solid, fast technologies like Vanilla JS, Firebase, and Tailwind/CSS. This guarantees applications that look professional and perform flawlessly under the hood. My tone of voice is always professional, accessible, innovative, and transparent.",
