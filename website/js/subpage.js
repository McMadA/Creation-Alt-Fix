document.addEventListener('DOMContentLoaded', async function() {
    ...
    const translations = {
        'nl': {
            ...
            "itCard1P": "Software- en systeemproblemen? Wij diagnosticeren en optimaliseren uw computer snel en vakkundig.",
            ...
            "overMijMissieP1": "Als gedreven IT-professional zet ik slimme idee\u00ebn om in werkende oplossingen met behulp van AI en moderne cloud-technologie\u00ebn. Technologie moet voor jou werken, niet andersom.",
            "overMijMissieP2": "Met een HBO-achtergrond in Network & Security Engineering en brede ervaring als Cloud Consultant (Cegeka) en Azure Architect, combineer ik diepgaande technische kennis met klantgericht denken. Ik ben analytisch, resultaatgericht en altijd op zoek naar optimalisatie.",
            "overMijMissieP3": "Binnen Creation+Alt+Fix ligt mijn focus uitsluitend op <strong>Software-Only Services</strong>. Denk aan cloud-infrastructuur (Azure), IT-automatisering en AI-implementaties. <span class=\"text-primary\">Let op: ik voer geen computer- of hardware reparaties meer uit.</span>",
            ...
            "overMijTechP": "Mijn expertise ligt op het snijvlak van Cloud en AI. Gecertificeerd als Microsoft AI Transformation Leader en Kubernetes Cloud Native Associate, combineer ik robuuste enterprise infrastructuur (zoals Microsoft Azure, M365, Python) met razendsnelle webtechnieken (Vanilla JS, Firebase, CSS). Dit garandeert applicaties die er niet alleen professioneel uitzien, maar onder de motorkap veilig en schaalbaar zijn.",
            ...
            "relITP": "Betrouwbare IT-ondersteuning en software support",
            ...
            "projectenCaseLabel": "Case Study \u2014 Intern Product",
            "projectenCaseTitle": "Creation+Alt+Fix CRM & Klantenportaal",
            "projectenCaseDesc": "Een volledig zelfontwikkeld CRM-systeem dat het complete klanttraject automatiseert: van eerste intake tot oplevering en facturatie. Gebouwd met zero-framework Vanilla JavaScript en Firebase als real-time backend.",
            "projectenCaseF1": "Real-time Firebase Tracking",
            "projectenCaseF2": "Digitale Offerte & Handtekening",
            "projectenCaseF3": "Geautomatiseerde Onboarding",
            "projectenCaseF4": "5-Fase Project Pipeline",
            "projectenCaseF5": "Klant Status Portaal",
            "projectenCaseF6": "Email & Push Notificaties",
            ...
            "pFtruckTitle": "Foodtruck Store (ftruckstore.nl)",
            "pFtruckDesc": "Bestaande e-commerce webshop en platform succesvol gemigreerd naar onze managed hostingomgeving. Inclusief veilige databaseoverzetting, DNS & mail-routing configuratie en 24/7 uptime monitoring.",
        ...
        'en': {
            ...
            "itCard1P": "Software and system issues? We diagnose and optimize your computer quickly and professionally.",
            ...
            "overMijMissieP1": "As a driven IT professional, I turn smart ideas into working solutions using AI and modern cloud technologies. Technology should work for you, not the other way around.",
            "overMijMissieP2": "With a Bachelor's background in Network & Security Engineering and broad experience as a Cloud Consultant (Cegeka) and Azure Architect, I combine in-depth technical knowledge with customer-centric thinking. I am analytical, results-oriented, and always looking for optimization.",
            "overMijMissieP3": "At Creation+Alt+Fix, my focus is strictly on <strong>Software-Only Services</strong>. This includes cloud infrastructure (Azure), IT automation, and AI implementations. <span class=\"text-primary\">Please note: I no longer perform computer or hardware repairs.</span>",
            ...
            "overMijTechP": "My expertise lies at the intersection of Cloud and AI. Certified as a Microsoft AI Transformation Leader and Kubernetes Cloud Native Associate, I combine robust enterprise infrastructure (like Microsoft Azure, M365, Python) with lightning-fast web technologies (Vanilla JS, Firebase, CSS). This ensures applications that not only look professional, but are secure and scalable under the hood.",
            ...
            "relITP": "Reliable IT support and software support",
            ...
            "projectenCaseLabel": "Case Study \u2014 Internal Product",
            "projectenCaseTitle": "Creation+Alt+Fix CRM & Client Portal",
            "projectenCaseDesc": "A fully self-developed CRM system that automates the complete client journey: from initial intake to delivery and invoicing. Built with zero-framework Vanilla JavaScript and Firebase as a real-time backend.",
            "projectenCaseF1": "Real-time Firebase Tracking",
            "projectenCaseF2": "Digital Quotes & Signatures",
            "projectenCaseF3": "Automated Onboarding",
            "projectenCaseF4": "5-Phase Project Pipeline",
            "projectenCaseF5": "Client Status Portal",
            "projectenCaseF6": "Email & Push Notifications",
            "projectenCaseCta": "Experience the Client Portal",
            ...
            "pSiegTitle": "Bakkertje Sieg",
            "pSiegDesc": "A fully functional webshop for selling recipes. Including recipe catalogue, shopping cart, payment integration and customer reviews.",
            "pScholteTitle": "Scholte-Elektrotechniek",
            ...
            "pFtruckTitle": "Foodtruck Store (ftruckstore.nl)",
            "pFtruckDesc": "Existing e-commerce webshop and platform successfully migrated to our managed hosting environment. Including secure database migration, DNS & mail routing configuration, and 24/7 uptime monitoring.",
            "pHbiTitle": "Home Buyer Intelligence",
