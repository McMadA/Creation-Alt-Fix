document.addEventListener('DOMContentLoaded', async function() {
    ...
    // --- LIVE DEMO & TECH LAB PAGE ---
    "liveDemoPageTitle": "Interactieve Live Demo & Tech Lab - Creation+Alt+Fix",
    "liveDemoMetaDesc": "Ervaar hands-on hoe Creation+Alt+Fix moderne web-applicaties bouwt: interactieve code studio, 7-laags AI Scrape Shield, CRM live staging annotator en AI prompt sandboxes.",
    "liveDemoBreadcrumb": "Tech Lab & Live Demo",
    "liveDemoHeroBadge": "Creation+Alt+Fix Interactive Tech Lab",
    "liveDemoH1": "Interactieve <span class=\"accent\">Live Demo & Studio</span>",
    "liveDemoSubtitle": "Ervaar hands-on hoe we web-applicaties, AI-automatiseringen, 7-laags security shields en realtime CRM staging tools bouwen. Test met live sliders, interactieve annotaties en code-inspectie.",
    "labTabStudio": "1. Live Code & Build Studio",
    "labTabShield": "2. 7-Laags AI Scrape Shield",
    "labTabStaging": "3. CRM Live Staging Annotator",
    "labTabAI": "4. AI Prompt & Data Sandbox",
    "labTabRadar": "5. Technologie Matrix (25+)",
    "labTag1": "Modulaire Architectuur",
    "studioH2": "De 4 Bouwstenen van een <span>Moderne Web-App</span>",
    "studioDesc": "Klik op een bouwfase om links de broncode te inspecteren en rechts live de interactieve transformatie in de render-engine te ervaren.",
    "step1Title": "Semantische HTML5 Blueprint",
    "step1Desc": "De zuivere structuur en inhoud: semantische tags, SEO metadata en accessibility landmarks (WCAG 2.1) zonder visuele ruis.",
    "step2Title": "Modern Glassmorphism & Design Tokens",
    "step2Desc": "Styling met CSS Custom Properties, backdrop-filter blur, subtiele gradient borders en glow effects in onze Dark AI stijl.",
    "step3Title": "ES6+ Reactive State & Micro-Interacties",
    "step3Desc": "Dynamische logica zonder zware frameworks: realtime prijsberekening, kortingscodes en soepele feedback toasts.",
    "step4Title": "Cloud Sync & AI Intelligence Injection",
    "step4Desc": "Sub-50ms realtime database synchronisatie via Firebase Firestore en intelligente AI productverrijking via Gemini API.",
    "ctrlColor": "Accent Thema:",
    "ctrlBlur": "Blur Kracht:",
    "ctrlRadius": "Border Radius:",
    "cardBadgeStandard": "Managed Cloud Service",
    "cardTitleHosting": "Managed Cloud Hosting All-in",
    "cardDescHosting": "Complete enterprise webhosting inclusief NVMe SSD opslag, automatische dagelijkse back-ups, 5 zakelijke mailboxen en gratis SSL.",
    "billingPeriod": "Facturatie:",
    "btnMonthly": "Maandelijks",
    "btnAnnual": "Jaarlijks (-20%)",
    "perMonth": "/ maand",
    "feat1": "10 GB Snelle NVMe Opslag",
    "feat2": "99.9% Uptime SLA & DirectAdmin",
    "feat3": "Real-time DDoS & AI Scrape Shield",
    "btnSelectPlan": "Pakket Kiezen",
    "toastSuccess": "Pakket succesvol geconfigureerd!",
    "labTag2": "Security & Privacy Shield",
    "shieldH2": "7-Laags <span>AI Scrape Shield Simulator</span>",
    "shieldDesc": "Gebaseerd op ons productiesysteem voor kunstenaars & bedrijven (o.a. Arnold Design). Bescherm afbeeldingen en intellectueel eigendom tegen ongewenste AI webscraping.",
    "watermarkText": "EU TDM Art. 4 Opt-Out<br>Machine-Readable Protection Active",
    "shieldTdmTitle": "EU TDM Art. 4 & No-AI Headers",
    "shieldTdmSub": "Directive 2019/790 tdm-reservation: 1 headers",
    "shieldNoiseTitle": "Canvas Watermark & CSS Noise Glitch",
    "shieldNoiseSub": "Verstoort AI-scrapers zonder menselijke kijkhinder",
    "shieldHoneypotTitle": "Honeypot Trap & CSF/LFD IP Ban",
    "shieldHoneypotSub": "Blokkeert agressieve bots direct op serverniveau",
    "btnSimulateBot": "Simuleer AI Scraper Aanval",
    "labTag3": "Creation+Alt+Fix Klantenportaal",
    "stagingH2": "Real-Time <span>Staging Annotator Simulator</span>",
    "stagingDesc": "In ons eigen ontwikkelde CRM plaatsen klanten visuele feedback-pins direct op het live prototype. Geen lange e-mails, maar directe visuele communicatie.",
    "mockTitle": "Boutique Schoonheidssalon & Wellness",
    "mockP": "Ervaar rust, exclusieve natuurlijke haarverzorging en pure ontspanning in het hart van Groningen.",
    "mockBtn": "Afspraak Plannen",
    "canvasHint": "Klik ergens op het scherm om een Feedback Pin te plaatsen!",
    "notesHeader": "Feedback Pins",
    "btnClearPins": "Wissen",
    "btnOpenPdf": "Genereer PDF Offerte & Handtekening",
    "labTag4": "Intelligente Automatisering",
    "aiH2": "AI Prompt & <span>Data Transform Engine</span>",
    "aiDesc": "Ontdek hoe we Google Gemini 2.0 / 3.7 en OpenAI inzetten voor gestructureerde dataverwerking, automatische SEO teksten en slimme bedrijfsprocessen.",
    "lblPromptInput": "Invoer / Bedrijfsinformatie:",
    "btnRunAI": "Voer AI Transformatie Uit",
    "labTag5": "Onze Technologie Stack",
    "radarH2": "Technologie Matrix & <span>Skills Radar</span>",
    "radarDesc": "Een selectie van de beproefde frameworks, talen, cloud infrastructuren en security tools waarmee Creation+Alt+Fix dagelijks bouwt.",
    "filterAll": "Alles (20+)",
    "filterFront": "Frontend & UI",
    "filterAI": "AI & Data",
    "filterCloud": "Cloud & Backend",
    "filterDevops": "DevOps & Tools",
    "filterSec": "Security",
    "ctaTitle": "Klaar om jouw idee om te zetten in krachtige software?",
    "ctaSubtitle": "Van een bliksemsnelle website of AI-tool tot een custom portaal op maat. Start vandaag nog een vrijblijvende intake.",
    "btnStartIntake": "Start Project Intake",
    "btnViewPortfolio": "Bekijk Portfolio (14+)",
    "btnContactUs": "Neem Contact Op",
    "pinModalTitle": "Nieuwe Feedback Pin Toevoegen",
    "lblPinTitle": "Wat wil je hier aanpassen?",
    "lblPinDesc": "Toelichting (optioneel):",
    "btnSavePin": "Pin Opslaan",
    "pdfModalTitle": "Offerte & Akkoord Simulator",
    ...
    "webH2Tarieven": "Transparent Rates & Managed Hosting",
    "webPPackagesLead": "At Creation+Alt+Fix you know exactly what to expect. No hidden fees, including lightning-fast Dutch NVMe hosting and full technical peace of mind.",
    ...
    "workflowSectionSubtitle": "No black boxes or ambiguous timelines. From day one, track every single detail of your website or software project live in your dedicated Creation+Alt+Fix Client Portal.",
    "wfStep1Badge": "Stage 1",
    "wfStep1Title": "1. Smart Intake & Scope",
    "wfStep1Desc": "Submit your goals, brand style, and requirements in 2 minutes. Our AI engine instantly scopes your project and initializes your secure portal account.",
    "wfStep1Pill": "Real-time Account",
    "wfStep2Badge": "Stage 2",
    "wfStep2Title": "2. Transparent Proposal",
    "wfStep2Desc": "Itemized proposal including high-speed hosting (€150/yr) with zero hidden fees. 1-click digital signature and instant PDF download.",
    "wfStep2Pill": "Digital Signature & PDF",
    "wfStep3Badge": "Stage 3",
    "wfStep3Title": "3. Design & Concept Review",
    "wfStep3Desc": "We align on color schemes, typography, and interactive wireframes. We only begin engineering once you give visual sign-off.",
    "wfStep3Pill": "Visual Sign-off",
    "wfStep4Badge": "Stage 4 • Highlight",
    "wfStep4Title": "4. Live Staging & Pin-Feedback",
    "wfStep4Desc": "Review your site live in a responsive desktop/tablet/mobile emulator. Click directly on buttons or text to pin feedback (Design, Text, Bug).",
    "wfStep4Pill": "Point-and-Click Pins",
    "wfStep5Badge": "Stage 5",
    "wfStep5Title": "5. Launch & Handover",
    "wfStep5Desc": "Final quality check, DNS & domain cutover, access to Pi accounting invoices, and official system documentation guide.",
    "wfStep5Pill": "Pi Invoices & Docs",
    "wfBannerBadge": "Included with Every Project",
    "wfBannerTitle": "Real-time control over your digital assets at all times",
    "wfBannerDesc": "Experience the clarity of a dedicated portal featuring live messaging, file sharing, digital quotes, and interactive staging annotations.",
    "wfBannerCtaIntake": "Start Your Intake",
    "wfBannerCtaCase": "View CRM Case Study",
    "wfBannerCtaPortal": "To Portal",
    ...
    // --- LIVE DEMO & TECH LAB PAGE ---
    "liveDemoPageTitle": "Interactive Live Demo & Tech Lab - Creation+Alt+Fix",
    "liveDemoMetaDesc": "Experience hands-on how Creation+Alt+Fix builds modern web apps: interactive code studio, 7-layer AI Scrape Shield, CRM live staging annotator, and AI prompt sandboxes.",
    "liveDemoBreadcrumb": "Tech Lab & Live Demo",
    "liveDemoHeroBadge": "Creation+Alt+Fix Interactive Tech Lab",
    "liveDemoH1": "Interactive <span class=\"accent\">Live Demo & Studio</span>",
    "liveDemoSubtitle": "Experience hands-on how we build web applications, AI automations, 7-layer security shields, and realtime CRM staging tools. Test with live sliders, interactive annotations, and code inspection.",
    "labTabStudio": "1. Live Code & Build Studio",
    "labTabShield": "2. 7-Layer AI Scrape Shield",
    "labTabStaging": "3. CRM Live Staging Annotator",
    "labTabAI": "4. AI Prompt & Data Sandbox",
    "labTabRadar": "5. Technology Matrix (25+)",
    "labTag1": "Modular Architecture",
    "studioH2": "The 4 Pillars of a <span>Modern Web App</span>",
    "studioDesc": "Click a build phase to inspect the source code on the left and experience the interactive transformation live in the render engine on the right.",
    "step1Title": "Semantic HTML5 Blueprint",
    "step1Desc": "Pure structure and content: semantic tags, SEO metadata, and accessibility landmarks (WCAG 2.1) with zero visual bloat.",
    "step2Title": "Modern Glassmorphism & Design Tokens",
    "step2Desc": "Styling with CSS Custom Properties, backdrop-filter blur, subtle gradient borders, and glow effects in our Dark AI theme.",
    "step3Title": "ES6+ Reactive State & Micro-Interactions",
    "step3Desc": "Dynamic logic without bulky frameworks: real-time price calculations, promo code validation, and smooth feedback toasts.",
    "step4Title": "Cloud Sync & AI Intelligence Injection",
    "step4Desc": "Sub-50ms real-time database synchronization via Firebase Firestore and intelligent AI product enrichment via Gemini API.",
    "ctrlColor": "Accent Theme:",
    "ctrlBlur": "Blur Strength:",
    "ctrlRadius": "Border Radius:",
    "cardBadgeStandard": "Managed Cloud Service",
    "cardTitleHosting": "Managed Cloud Hosting All-in",
    "cardDescHosting": "Complete enterprise web hosting including NVMe SSD storage, automated daily backups, 5 business mailboxes, and free SSL.",
    "billingPeriod": "Billing:",
    "btnMonthly": "Monthly",
    "btnAnnual": "Annually (-20%)",
    "perMonth": "/ month",
    "feat1": "10 GB High-Speed NVMe Storage",
    "feat2": "99.9% Uptime SLA & DirectAdmin",
    "feat3": "Real-time DDoS & AI Scrape Shield",
    "btnSelectPlan": "Select Plan",
    "toastSuccess": "Plan successfully configured!",
    "labTag2": "Security & Privacy Shield",
    "shieldH2": "7-Layer <span>AI Scrape Shield Simulator</span>",
    "shieldDesc": "Based on our production security system for artists & companies (including Arnold Design). Protect artworks and IP against unwanted AI web scraping.",
    "watermarkText": "EU TDM Art. 4 Opt-Out<br>Machine-Readable Protection Active",
    "shieldTdmTitle": "EU TDM Art. 4 & No-AI Headers",
    "shieldTdmSub": "Directive 2019/790 tdm-reservation: 1 headers",
    "shieldNoiseTitle": "Canvas Watermark & CSS Noise Glitch",
    "shieldNoiseSub": "Disrupts AI crawlers without hindering human visual experience",
    "shieldHoneypotTitle": "Honeypot Trap & CSF/LFD IP Ban",
    "shieldHoneypotSub": "Instantly blocks aggressive scrapers at the server firewall level",
    "btnSimulateBot": "Simulate AI Scraper Attack",
    "labTag3": "Creation+Alt+Fix Client Portal",
    "stagingH2": "Real-Time <span>Staging Annotator Simulator</span>",
    "stagingDesc": "In our custom-built CRM, clients place visual feedback pins directly on live prototypes. No messy email threads, just clear visual collaboration.",
    "mockTitle": "Boutique Hair Salon & Wellness",
    "mockP": "Experience serenity, exclusive natural hair treatments, and pure relaxation in the heart of Groningen.",
    "mockBtn": "Book Appointment",
    "canvasHint": "Click anywhere on the screen below to place a Feedback Pin!",
    "notesHeader": "Feedback Pins",
    "btnClearPins": "Clear All",
    "btnOpenPdf": "Generate PDF Proposal & Signature",
    "labTag4": "Intelligent Automation",
    "aiH2": "AI Prompt & <span>Data Transform Engine</span>",
    "aiDesc": "Discover how we leverage Google Gemini 2.0 / 3.7 and OpenAI for structured data parsing, automated SEO copywriting, and streamlined business workflows.",
    "lblPromptInput": "Input / Business Profile:",
    "btnRunAI": "Execute AI Transformation",
    "labTag5": "Our Technology Stack",
    "radarH2": "Technology Matrix & <span>Skills Radar</span>",
    "radarDesc": "A selection of proven frameworks, languages, cloud infrastructures, and security tools Creation+Alt+Fix uses daily.",
    "filterAll": "All (20+)",
    "filterFront": "Frontend & UI",
    "filterAI": "AI & Data",
    "filterCloud": "Cloud & Backend",
    "filterDevops": "DevOps & Tools",
    "filterSec": "Security",
    "ctaTitle": "Ready to turn your idea into powerful software?",
    "ctaSubtitle": "From a blazing-fast website or AI tool to a custom client portal. Start a free consultation and project intake today.",
    "btnStartIntake": "Start Project Intake",
    "btnViewPortfolio": "View Portfolio (14+)",
    "btnContactUs": "Get in Touch",
    "pinModalTitle": "Add New Feedback Pin",
    "lblPinTitle": "What would you like to modify here?",
    "lblPinDesc": "Details (optional):",
    "btnSavePin": "Save Pin",
    "pdfModalTitle": "Proposal & Agreement Simulator",
