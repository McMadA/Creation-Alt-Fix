...
(function() {
    const translations = {
        nl: {
            text: 'Wij gebruiken functionele en geanonimiseerde analytische cookies om uw gebruikerservaring op onze website te verbeteren. Lees onze <a href="/privacy-policy.html" style="color: var(--color-accent, #6366f1); text-decoration: underline;">Privacyverklaring</a> voor meer informatie.',
            accept: 'Accepteren',
            decline: 'Weigeren'
        },
        en: {
            text: 'We use functional and anonymized analytical cookies to improve your user experience on our website. Read our <a href="/privacy-policy.html" style="color: var(--color-accent, #6366f1); text-decoration: underline;">Privacy Policy</a> for more information.',
            accept: 'Accept',
            decline: 'Decline'
        }
    };
